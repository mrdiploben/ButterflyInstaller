...
main() {
  ...
  if [ -d "/etc/pterodactyl" ]; then
    warning "The script has detected that you already have the butterfly's wings on your system! You cannot run the script multiple times, it will fail!"
...
function goodbye {
  echo ""
  print_brake 70
  echo "* The butterfly's Wings installation has completed"
  echo "*"
  echo "* To continue, you need to configure the butterfly's Wings to run with your panel"

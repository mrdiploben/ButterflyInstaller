...
summary() {
  print_brake 30
  output "Uninstall butterfly panel? $RM_PANEL"
  output "Uninstall the butterfly's wings? $RM_WINGS"
  print_brake 30
}

goodbye() {
  print_brake 62
  [ "$RM_PANEL" == true ] && output "Butterfly Panel uninstallation completed"
  [ "$RM_WINGS" == true ] && output "Butterfly's Wings uninstallation completed"

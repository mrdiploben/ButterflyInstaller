...
main() {
  ...
  if [ -d "/var/www/pterodactyl" ]; then
    warning "The script has detected that you already have Butterfly panel/Pterodactyl Panel on your system! You cannot run the script multiple times, it will fail!"
